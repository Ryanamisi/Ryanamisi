...
**Student Name:** [Ryan Amisi]  
**Date:** [2026-09-21]  
**Course:** CS 457 - Computer Networks  
**Target Server Domain:** server.amisi.edu  
...
- **Game Summary:** Tic-Tac-Toe game played on a 3x3 grid.  Players take turns choosing spaces until one player wins or the game ends in a tie.

### 1.2 Core Game Rules & Win/Draw Conditions
- **Turn Mechanics:** Player 1 uses X and player 2 uses O.  The players alternate turns and choose one empty space on the 3x3 board.
- **Victory Condition:** A player wins by getting three of their symbols in a row horizontally, vertically, or diagonally.
- **Draw/Tie Condition:** The game ends in a tie if all nine spaces are filled and neither player has three in a row.
